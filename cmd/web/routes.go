...
func (app *application) routes() (http.Handler, error) {
	...
	mux.HandleFunc("GET /orgs/{org_id}/equipment/import/template", app.html.Handle(app.getEquipmentImportTemplate))
	...
	mux.HandleFunc("POST /orgs/{org_id}/equipment/{id}/units/bulk-inspect", app.html.Handle(app.postEquipmentBulkUpdateInspection))
	...
	mux.HandleFunc("GET /orgs/{org_id}/equipment/{id}/units/{unit_id}/barcode", app.html.Handle(app.getEquipmentUnitBarcode))
	...
	mux.HandleFunc("GET /orgs/{org_id}/equipment/{id}/part-of", app.html.Handle(app.getEquipmentPartOfFragment))
	mux.HandleFunc("GET /orgs/{org_id}/currency", app.html.Handle(app.getOrgCurrencyFragment))
	mux.HandleFunc("GET /orgs/{org_id}/equipment-categories", app.html.Handle(app.getEquipmentCategoriesFragment))
	mux.HandleFunc("GET /orgs/{org_id}/equipment-manufacturers", app.html.Handle(app.getEquipmentManufacturersFragment))
	mux.HandleFunc("GET /orgs/{org_id}/warehouse-locations", app.html.Handle(app.getEquipmentLocationsFragment))
