...
func (q *Queries) Create(ctx context.Context, arg CreateParams) (Location, error) {
...
func (q *Queries) GetByID(ctx context.Context, id string) (Location, error) {
...
func (q *Queries) GetByName(ctx context.Context, arg GetByNameParams) (Location, error) {
...
func (q *Queries) GetByOrgID(ctx context.Context, orgID string) ([]Location, error) {
...
func (q *Queries) Update(ctx context.Context, arg UpdateParams) (Location, error) {
